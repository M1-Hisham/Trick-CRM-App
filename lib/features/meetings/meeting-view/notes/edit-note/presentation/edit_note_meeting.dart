...
import '../logic/cubit/edit_note_meeting_cubit.dart';

class EditNoteMeeting extends StatelessWidget {
  final int meetingId;
  final int noteId;
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<EditNoteMeetingCubit>(),
          ...
          child: AppButton(
            ...
            onPressed: () async {
              if (_formKey.currentState!.validate()) {
                ...
                await getIt<EditNoteMeetingCubit>().editMeetingNote(
                  meetingId,
                  noteId,
