...
part 'this_quarter_sales_model.g.dart';

@JsonSerializable()
class ThisQuarterSalesModel {
  List<Data>? data;

  ThisQuarterSalesModel({this.data});

  factory ThisQuarterSalesModel.fromJson(Map<String, dynamic> json) =>
      _$ThisQuarterSalesModelFromJson(json);
}
...
class Data {
  ...
  Data({this.quarter, this.start, this.end, this.deals});
