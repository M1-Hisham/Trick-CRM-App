...
part of 'this_quarter_sales_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ThisQuarterSalesModel _$ThisQuarterSalesModelFromJson(
        Map<String, dynamic> json) =>
    ThisQuarterSalesModel(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => Data.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$ThisQuarterSalesModelToJson(
        ThisQuarterSalesModel instance) =>
    <String, dynamic>{
      'data': instance.data,
    };
