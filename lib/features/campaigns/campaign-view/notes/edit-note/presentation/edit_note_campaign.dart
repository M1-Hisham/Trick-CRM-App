...
import '../logic/cubit/edit_note_campaign_cubit.dart';

class EditNoteCampaign extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<EditNoteCampaignCubit>(),
          ...
          child: AppButton(
            ...
            onPressed: () async {
              if (_formKey.currentState!.validate()) {
                ...
                await getIt<EditNoteCampaignCubit>().editCampaignNote(
                  campaignId,
                  noteId,
