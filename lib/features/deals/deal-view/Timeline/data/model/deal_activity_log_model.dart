...
part 'deal_activity_log_model.g.dart';

@JsonSerializable()
class DealActivityLogModel {
  int? id;
  ...
  DealActivityLogModel(
      ...
      this.updatedAt,
      this.causer});
  factory DealActivityLogModel.fromJson(Map<String, dynamic> json) =>
      _$DealActivityLogModelFromJson(json);
}
