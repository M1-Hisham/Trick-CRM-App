...
part 'campaign_activity_log_model.g.dart';

@JsonSerializable()
class CampaignActivityLogModel {
  int? id;
  ...
  CampaignActivityLogModel(
      ...
      this.updatedAt,
      this.causer});
  factory CampaignActivityLogModel.fromJson(Map<String, dynamic> json) =>
      _$CampaignActivityLogModelFromJson(json);
}
