...
part of 'deals_closing_this_month_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DealsClosingThisMonthModel _$DealsClosingThisMonthModelFromJson(
        Map<String, dynamic> json) =>
    DealsClosingThisMonthModel(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => Data.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$DealsClosingThisMonthModelToJson(
        DealsClosingThisMonthModel instance) =>
    <String, dynamic>{
      'data': instance.data,
    };
