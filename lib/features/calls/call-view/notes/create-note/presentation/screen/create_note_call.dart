...
import '../../logic/cubit/create_note_call_cubit.dart';

class CreateNoteCall extends StatelessWidget {
  final int callId;
  final BuildContext contextNotes;
  CreateNoteCall({super.key, required this.callId, required this.contextNotes});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<CreateNoteCallCubit>(),
          ...
          child: AppButton(
            ...
            onPressed: () async {
              if (_formKey.currentState!.validate()) {
                ...
                await getIt<CreateNoteCallCubit>().createCallNote(
