...
import '../../logic/cubit/create_note_campaign_cubit.dart';

class CreateNoteCampaign extends StatelessWidget {
  final int campaignId;
  final BuildContext contextNotes;
  CreateNoteCampaign(
      {super.key, required this.campaignId, required this.contextNotes});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<CreateNoteCampaignCubit>(),
          ...
          child: AppButton(
            ...
            onPressed: () async {
              if (_formKey.currentState!.validate()) {
                ...
                await getIt<CreateNoteCampaignCubit>().createCampaignNote(
