...
part 'sales_by_person_model.g.dart';

@JsonSerializable()
class SalesByPersonModel {
  List<Data>? data;

  SalesByPersonModel({this.data});

  factory SalesByPersonModel.fromJson(Map<String, dynamic> json) =>
      _$SalesByPersonModelFromJson(json);
}
