...
class AttachmentCampaignBlocBuilder extends StatelessWidget {
  final int campaignId;
  const AttachmentCampaignBlocBuilder({super.key, required this.campaignId});
          ...
          success: (data) {
            return Column(
              ...
              children: [
                ...
                spacingV(20),
                data.campaignAttachments?.isEmpty ?? true
                    ...
                    : GridView.builder(
                        ...
                        itemCount: data.campaignAttachments?.length ?? 0,
                        itemBuilder: (context, index) {
                          final attachment = data.campaignAttachments?[index];
                          return ClipRRect(
                                ...
                                Positioned(
                                  ...
                                  child: CircleAvatar(
                                    ...
                                    child: IconButton(
                                      ...
                                      onPressed: () => deleteAttachmentCampaign(
                                        context,
                                        campaignId,
                                        attachment?.id ?? 0,
                                      ),
