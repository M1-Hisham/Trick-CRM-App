...
import '../data/model/closed_deals_model.dart';

class ClosedDealsScreen extends StatelessWidget {
  const ClosedDealsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar("Closed Deals"),
      body: BlocBuilder<GetDealsReportsCubit<ClosedDealsModels>,
          BaseState<ClosedDealsModels>>(
        ...
        builder: (context, state) {
          return state.maybeWhen(
            ...
            error: (message) => appErrorMessage(
              ...
              () {
                context
                    .read<GetDealsReportsCubit<ClosedDealsModels>>()
