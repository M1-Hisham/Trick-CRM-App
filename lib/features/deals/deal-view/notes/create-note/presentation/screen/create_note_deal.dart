...
import '../../logic/cubit/create_note_deal_cubit.dart';


class CreateNoteDeal extends StatelessWidget {
  final int dealId;
  final BuildContext contextNotes;
  CreateNoteDeal({super.key, required this.dealId, required this.contextNotes});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<CreateNoteDealCubit>(),
          ...
          child: AppButton(
            ...
            onPressed: () async {
              if (_formKey.currentState!.validate()) {
                ...
                await getIt<CreateNoteDealCubit>().createDealNote(
