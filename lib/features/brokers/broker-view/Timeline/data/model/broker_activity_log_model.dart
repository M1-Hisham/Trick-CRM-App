...
part 'broker_activity_log_model.g.dart';

@JsonSerializable()
class BrokerActivityLogModel {
  int? id;
  ...
  BrokerActivityLogModel(
      ...
      this.updatedAt,
      this.causer});
  factory BrokerActivityLogModel.fromJson(Map<String, dynamic> json) =>
      _$BrokerActivityLogModelFromJson(json);
}
