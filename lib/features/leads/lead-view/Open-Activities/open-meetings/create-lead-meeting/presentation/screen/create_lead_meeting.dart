...
import '../../logic/cubit/create_lead_meeting_cubit.dart';

class CreateLeadMeeting extends StatefulWidget {
  final int leadId;
  final String leadName;
  final List<Users> users;
  final List<HostUsers> hostUsers;
  const CreateLeadMeeting({
    super.key,
  ...
  @override
  State<CreateLeadMeeting> createState() => _CreateLeadMeetingState();
}

class _CreateLeadMeetingState extends State<CreateLeadMeeting> {
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            left: 0,
            right: 0,
            child: appTopBarDialog('Add a New Meeting'),
          ),
        ],
      ),
    );
  ...
  void _submitCreate(context) async {
    if (_formKey.currentState!.validate()) {
      ...
      var createLeadMeetingRequestBody = CreateMeetingRequestBody(
        ...
        // _formData["leadId"] != null && _formData["leadId"] != ""
      ...
      await getIt<CreateLeadMeetingCubit>()
          .createLeadMeeting(createLeadMeetingRequestBody, widget.leadId);
