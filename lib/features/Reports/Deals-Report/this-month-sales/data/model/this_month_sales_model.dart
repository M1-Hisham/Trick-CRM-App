...
part 'this_month_sales_model.g.dart';

@JsonSerializable()
class ThisMonthSalesModel {
  List<Data>? data;

  ThisMonthSalesModel({this.data});
  factory ThisMonthSalesModel.fromJson(Map<String, dynamic> json) =>
      _$ThisMonthSalesModelFromJson(json);
}
