...
part 'deal_attatchments_model.g.dart';

@JsonSerializable()
class DealAttatchmentsModel {
  int? id;
  ...
  factory DealAttatchmentsModel.fromJson(Map<String, dynamic> json) =>
      _$DealAttatchmentsModelFromJson(json);
}
