...
import '../../../features/meetings/delete-meeting/logic/cubit/delete_meeting_cubit.dart';
...
void setupMeetingsModule() {
  ...
  getIt.registerLazySingleton<DeleteMeetingCubit>(
      () => DeleteMeetingCubit(getIt<ApiService>()));
}
