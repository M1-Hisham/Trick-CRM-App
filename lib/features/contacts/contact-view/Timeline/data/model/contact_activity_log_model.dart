...
part 'contact_activity_log_model.g.dart';

@JsonSerializable()
class ContactActivityLogModel {
  int? id;
  ...
  ContactActivityLogModel(
      ...
      this.updatedAt,
      this.causer});
  factory ContactActivityLogModel.fromJson(Map<String, dynamic> json) =>
      _$ContactActivityLogModelFromJson(json);
}
