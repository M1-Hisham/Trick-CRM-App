...
import '../../logic/cubit/create_note_broker_cubit.dart';

class CreateNoteBroker extends StatelessWidget {
  final int brokerId;
  final BuildContext contextNotes;
  CreateNoteBroker(
      {super.key, required this.brokerId, required this.contextNotes});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<CreateNoteBrokerCubit>(),
          ...
          child: AppButton(
            ...
            onPressed: () async {
              if (_formKey.currentState!.validate()) {
                ...
                await getIt<CreateNoteBrokerCubit>().createBrokerNote(
