...
part 'meeting_attatchments_model.g.dart';

@JsonSerializable()
class MeetingAttatchmentsModel {
  int? id;
  ...
  factory MeetingAttatchmentsModel.fromJson(Map<String, dynamic> json) =>
      _$MeetingAttatchmentsModelFromJson(json);
}
