...
import 'package:trick_crm_app/features/contacts/contact-view/Attatchments/delete_attachment/presentation/screen/delete_attachment_contact.dart';
import 'package:trick_crm_app/features/contacts/contact-view/contact-view/data/model/contacts_view_model.dart';
import 'package:trick_crm_app/features/contacts/contact-view/contact-view/logic/cubit/contact_view_cubit.dart';
...
class AttachmentContactBlocBuilder extends StatelessWidget {
  final int contactId;
  const AttachmentContactBlocBuilder({super.key, required this.contactId});
          ...
          success: (data) {
            return Column(
              ...
              children: [
                ...
                spacingV(20),
                data.contactAttatchment?.isEmpty ?? true
                    ...
                    : GridView.builder(
                        ...
                        itemCount: data.contactAttatchment?.length ?? 0,
                        itemBuilder: (context, index) {
                          final attachment = data.contactAttatchment?[index];
                          return ClipRRect(
                                ...
                                Positioned(
                                  ...
                                  child: CircleAvatar(
                                    ...
                                    child: IconButton(
                                      ...
                                      onPressed: () => deleteAttachmentContact(
                                        context,
                                        contactId,
                                        attachment?.id ?? 0,
                                      ),
