...
import 'package:trick_crm_app/features/calls/create-call/data/model/create_call_request_body.dart';
...
import '../../../../../create-lead/presentation/widgets/top_bar_dialog.dart';
import '../../../../lead-view/data/model/leads_view_model.dart';

class CreateLeadCallScreen extends StatefulWidget {
  final List<Users> ownerList;
  final int leadId;
  const CreateLeadCallScreen({
    super.key,
  ...
  @override
  State<CreateLeadCallScreen> createState() => _CreateLeadCallScreenState();
}

class _CreateLeadCallScreenState extends State<CreateLeadCallScreen> {
