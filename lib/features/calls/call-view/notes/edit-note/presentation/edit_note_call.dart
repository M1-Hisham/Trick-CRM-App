...
import '../logic/cubit/edit_note_call_cubit.dart';

class EditNoteCall extends StatelessWidget {
  final int callId;
  final int noteId;
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<EditNoteCallCubit>(),
          ...
          child: AppButton(
            ...
            onPressed: () async {
              if (_formKey.currentState!.validate()) {
                ...
                await getIt<EditNoteCallCubit>().editCallNote(
                  callId,
                  noteId,
