...
part 'broker_attatchments_model.g.dart';

@JsonSerializable()
class BrokerAttatchmentsModel {
  int? id;
  ...
  factory BrokerAttatchmentsModel.fromJson(Map<String, dynamic> json) =>
      _$BrokerAttatchmentsModelFromJson(json);
}
