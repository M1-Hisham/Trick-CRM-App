...
TaskViewModel _$TaskViewModelFromJson(Map<String, dynamic> json) =>
    TaskViewModel(
      ...
      task: json['task'] == null
          ? null
          : TaskViewData.fromJson(json['task'] as Map<String, dynamic>),
    );
...
TaskViewData _$TaskViewDataFromJson(Map<String, dynamic> json) => TaskViewData(
...
Map<String, dynamic> _$TaskViewDataToJson(TaskViewData instance) =>
    <String, dynamic>{
      'id': instance.id,
