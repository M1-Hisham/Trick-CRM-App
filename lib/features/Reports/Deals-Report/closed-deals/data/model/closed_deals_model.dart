...
part 'closed_deals_model.g.dart';

@JsonSerializable()
class ClosedDealsModels {
  List<Data>? data;

  ClosedDealsModels({this.data});
  factory ClosedDealsModels.fromJson(Map<String, dynamic> json) =>
      _$ClosedDealsModelsFromJson(json);
}
