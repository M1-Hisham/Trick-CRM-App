...
class NotesContactViewCubit extends BaseCubit<ContactsViewModel> {
  NotesContactViewCubit(ApiService apiService)
      : super(
          BaseRepo(
  ...
  Future<void> getNotesView(int contactId) async {
