...
import '../logic/cubit/edit_note_deal_cubit.dart';

class EditNoteDeal extends StatelessWidget {
  final int dealId;
  final int noteId;
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<EditNoteDealCubit>(),
          ...
          child: AppButton(
            ...
            onPressed: () async {
              if (_formKey.currentState!.validate()) {
                ...
                await getIt<EditNoteDealCubit>().editDealNote(
                  dealId,
                  noteId,
