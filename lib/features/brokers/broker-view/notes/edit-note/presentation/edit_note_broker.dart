...
import '../logic/cubit/edit_note_broker_cubit.dart';

class EditNoteBroker extends StatelessWidget {
  final int brokerId;
  final int noteId;
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<EditNoteBrokerCubit>(),
          ...
          child: AppButton(
            ...
            onPressed: () async {
              if (_formKey.currentState!.validate()) {
                ...
                await getIt<EditNoteBrokerCubit>().editBrokerNote(
                  brokerId,
                  noteId,
